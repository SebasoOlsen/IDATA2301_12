...
import {
  ...
  submitForm,
} from "../service/api/userRegistration.js";
    ...
    <div className="container">
      ...
      <form
        ...
        className={`register-form ${
          registerFormHidden ? "register-form-hidden" : ""
        }`}
      ...
      >
        ...
        {showTelephoneMessage && (
          <p
            className={"availabilityMessage"}
            style={{ color: telephoneMessageColor }}
          >
            {telephoneMessage}
          </p>
        )}
      ...
      <div
        ...
        className={`successMessage ${
          successMessageHidden ? "successMessage-hidden" : ""
        }`}
      >
        <p>User was created successfully!</p>
        <button id="successMessageButton" onClick={() => navigate("/login")}>
          Back to login
        </button>
      </div>
      ...
      <div className="extra-info">
        <p>
          ...
          <Link to="/login">Terms &amp; Conditions</Link> and{" "}
          <Link to="/login">Privacy Statement</Link>.
        </p>
      </div>
    </div>
  );
